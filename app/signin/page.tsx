...
export default function Login() {
  ...
  return (
    <div className="flex justify-center bg-neutral-700 h-screen">
      <div className="flex flex-col h-[500px] w-[500px] bg-neutral-600 shadow-xl rounded mt-4">
        ...
        <div className="flex items-center flex-col text-black">
          ...
          />
          <label className="font-semibold text-xs mt-4">Contraseña</label>
          <div className="flex flex-row">
            <input
              className="flex items-center h-10 px-4 w-60 bg-white mt-2 rounded-l-sm focus:outline-none focus:ring-2"
            ...
            {!hiddenPw ? (
              <button
                ...
                className="bg-white h-10 flex justify-center items-center mt-2 rounded-r-sm"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="18"
          ...
          <button
            ...
            type="button"
            className="h-auto w-auto p-3 inline-block m-2 rounded-lg bg-amber-600 text-lg mt-6 font-medium text-white"
          >
            Ingresar
          </button>
        </div>
