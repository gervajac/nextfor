  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row justify-center h-[50px] w-full shadow-md">
        <h6 className="flex justify-center items-center font-bold text-orange-700">
          RANKING
        </h6>
        {posts.data.rank &&
          posts.data.rank.map((e) => {
            return (
              <h6 className="flex justify-center items-center px-6 space-x-2">
                <span className="flex font-semibold text-orange-700 ">
                  {e.userName}
                </span>
            ...
            return (
              <div className="flex flex-col bg-gray-700 border border-gray-600 shadow-2xl p-1">
                <Link
                  href="/posts/id"
                  as={`/post/${e.id}`}
                  className="flex justify-center text-xl underline hover:text-orange-500 bg-slate-500 p-1"
                >
                  {e.title}
                </Link>
                ...
                <div className="flex items-center flex-row w-full bg-slate-500 space-x-2">
                  <img
                    src={e.author.image}
